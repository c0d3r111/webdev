...
!function() {
        ...
        util     : {
            ...
            getLedger()               {
                ...
                void Object.keys(State.ledger)
                    .sort((a, b) => State.ledger[b].n.charCodeAt() - State.ledger[a].n.charCodeAt())
                    .forEach(hash => {
    ...
    void window.addEventListener('blur', Control.util.lockscreen);
    void window.addEventListener('focus', () => clearTimeout(State._timer || -1));
